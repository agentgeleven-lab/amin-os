...
export function mount(target){
 ...
 function draw(){
  ...
  if(page==='global'){
   select(body,'主页磁贴风格',[['classic','风格 1 · 跟随主题'],['win10','风格 2 · Windows 10']],draft.desktop.style,v=>draft.desktop.style=v);body.append(el('p','风格 2 使用深色开始屏与彩色磁贴；应用内页继续使用各自的外观设置。'));
