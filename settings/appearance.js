...
export const defaults=()=>({global:{theme:'mint',fontSize:13,radius:14,density:'comfortable',opacity:100,blur:12},window:{width:448,height:720},desktop:{style:'classic',windowTheme:'auto',effects:effectsDefaults()},apps:{},floor:{width:900,desktopHeight:65,mobileHeight:55,alignment:'left',sizeMode:'fixed',buttons:{map:true,status:true,reply:true},overrides:{}}});
