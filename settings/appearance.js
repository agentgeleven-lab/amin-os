...
export const APP_NAMES={tts:'语音朗读',worldbooks:'世界书管理',information:'信息面板',effects:'能力面板',map:'地图',status:'世界状态',organizations:'势力概览',reply:'回复选项',stylewriter:'文风转换',ai:'AI 设置'};
export const defaults=()=>({global:{theme:'mint',fontSize:13,radius:14,density:'comfortable',opacity:100,blur:12},window:{width:448,height:720},desktop:{style:'classic',windowTheme:'auto',effects:effectsDefaults()},apps:{},floor:{width:900,desktopHeight:65,mobileHeight:55,alignment:'left',sizeMode:'fixed',buttons:{map:true,status:true,organizations:true,reply:true,effects:true,information:true,worldbooks:true,tts:true},overrides:{}}});
...
export function installAppearance(document){
 ...
 const selector='.amin-floor,.dm-message-map,.dynamic-map-panel,.amin-app-pane,.amin-writing-page,.wsh-floor-host,.amin-reply-floor,.amin-extra-floor,.wsh-dialog,iframe';
