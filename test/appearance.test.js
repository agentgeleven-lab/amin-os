...
test('floor button visibility migrates and reply sizes persist independently',()=>{
 const old=validate({floor:{width:800}});assert.deepEqual(old.floor.buttons,{map:true,status:true,organizations:true,reply:true,effects:true,information:true,worldbooks:true,tts:true});
