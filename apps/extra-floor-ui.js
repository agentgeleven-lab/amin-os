...
export function installExtraFloorButtons(id){
 ...
 const titleText=id==='effects'?'能力面板':'信息面板',mountApp=id==='effects'?mountEffects:mountInformation;
 ...
 function attach(element){
  ...
  const host=node('div','amin-extra-floor'),button=node('button','',(id==='effects'?'✦ ':'▤ ')+titleText);button.type='button';button.setAttribute('aria-expanded','false');button.title='打开当前聊天的'+titleText;
