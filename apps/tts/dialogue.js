...
export function profiles(config){return Object.fromEntries(['dialogue','narration'].map(type=>[type,{speed:config.speed??1,volume:config.volume??1,pauseMs:0,...config.profiles?.[type]}]));}
