...
如果设定或状态规则要求好感度，将其拆成每个相关角色各自的数字“好感度”和文本“好感阶段”，不要合写为“75 - 感情加深”。阶段严格按适用规则的区间表对应数值，不编造阶段表。仅当好感度确有依据或规则明确给出初值时填写数字；缺少依据应说明待确定，不擅自假设熟人的好感度为0。已有同义字段沿用名称，补充模式不擅自转换旧文本字段。
